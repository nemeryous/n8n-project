...
public class CheckoutService {
    ...
    /**
     * Mark orders as abandoned for n8n workflow processing Should be called by scheduled task
     */
    public List<Order> markAbandonedOrders(int abandonmentThresholdHours) {
        ...
        List<Order> pendingOrders =
                orderRepository.findPendingOrdersOlderThan(OrderStatus.PENDING, cutoffTime);
